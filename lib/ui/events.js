  ...
  constructor({ client, status, namespace, involvedObject }) {
    ...
    events_table.on('select', (_, i) => {
      ...
      until(promise)
        ...
        .then(response => {
          ...
          if (!error) return;
          console.error(`Error fetching event ${namespace}/${name}`);
    ...
    this.on(AddEvent, ({ screen, page }) => {
      ...
      until(promise)
        ...
        .then(response => {
          ...
          console.error(`Error creating events tab: ${msg}`);
    ...
    function* watchEventChanges(screen, page) {
      ...
      try {
        ...
        console.error(`Error updating event table ${e.toString()}`);
      }
    }
