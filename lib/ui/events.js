...
const { focus: { withFocusIndicator }, spinner: { until } } = require('./ui');
...
class Events extends EventEmitter {
  ...
  constructor ({ client, debug, status, namespace, involvedObject }) {
    ...
    // TODO: add filtering
    const events_table = withFocusIndicator(blessed.listtable({
      label  : label,
      top    : 1,
      width  : '100%',
      height : '50%-1',
    ...
    const event_details = withFocusIndicator(blessed.box({
