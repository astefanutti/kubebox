...
const { focus: { withFocusIndicator }, setLabel, spinner: { until } } = require('./ui');
...
class Dashboard extends EventEmitter {
  ...
  constructor({ screen, navbar, status, client, debug }) {
    ...
    const pods_table = withFocusIndicator(blessed.listtable({
      label  : 'Pods',
      parent : screen,
      left   : 0,
      top    : 1,
    ...
    const pod_log = withFocusIndicator(blessed.log({
      parent : screen,
      label  : 'Logs',
      top    : '50%',
      bottom : '1',
