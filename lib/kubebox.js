...
class Kubebox extends EventEmitter {
  ...
  constructor(screen, server) {
    ...
    screen.key(['e'], () => {
      ...
      const events_tab = new Events({ screen, client, debug, cancellations, navbar, namespace: current_namespace });
      navbar.add({
        name   : key,
        render : _ => {
          events_tab.render();
    ...
    screen.key(['C-e'], () => {
      ...
      const events_tab = new Events({ screen, client, debug, cancellations, navbar });
      navbar.add({
        name   : key,
        render : _ => {
          events_tab.render();
