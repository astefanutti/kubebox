...
class Context {
  ...
  getMasterApi() {
    ...
    if (this.cluster['certificate-authority']) {
      api.ca = fs.readFileSync(this.cluster['certificate-authority']);
    }
    if (this.cluster['certificate-authority-data']) {
