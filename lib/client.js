...
class Client {
  ...
  events(namespace) {
    return new WatchableRequest({ path: this.namespacedPath`/api/v1/events?limit=500${namespace}`, headers: { 'Accept' : 'application/json;as=Table;v=v1beta1;g=meta.k8s.io, application/json' }}, { client: this });
  }
